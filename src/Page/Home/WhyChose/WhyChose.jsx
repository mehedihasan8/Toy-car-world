...
const WhyChose = () => {
  return (
    <div className="bg-[#363636] text-white ">
      <h1 className="text-center text-4xl lg:text-6xl font-extrabold pt-16 pb-10 ">
        WHY CHOOSE US
      </h1>
      <div className="my-cunstom-container grid grid-cols-1 md:grid-cols-3 pb-24 ">
        <div className="text-center lg:text-left my-10 lg:my-4 lg:pb-24">
        ...
        <div className="text-center lg:text-left my-10 lg:my-4">
